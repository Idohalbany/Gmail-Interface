...
import { changePage, hidePromo, hideSocial } from '../../redux/paginate/paginate.actions'
import { selectPromo, selectSocial } from '../../redux/paginate/paginate.selectors'
...
const CategoryBtn = ({ changePage, hidePromo, hideSocial, selectPromo, selectSocial }) => {
    ...
    <CategoryButtonContainer>
      ...
      <CategoryButton2 color={color} onClick={handleChange2}>
        ...
        <ButtonInfo>
          <ButtonInfoTop>
            <p>Social</p>
            <ButtonInfoTitle className={selectSocial ? 'new-social' : 'new-social disappear'}>
              2 new
            </ButtonInfoTitle>
          </ButtonInfoTop>
          <ButtonInfoBottom className={selectSocial ? 'new-social' : 'new-social disappear'}>
            Twitter, LinkedIn
          </ButtonInfoBottom>
        </ButtonInfo>
      ...
      <CategoryButton3 color={color} onClick={handleChange3}>
        ...
        <ButtonInfo>
          <ButtonInfoTop>
            ...
            <ButtonInfoTitle className={selectPromo ? 'new-promo' : 'clear new-promo'}>
              1 new
            </ButtonInfoTitle>
          </ButtonInfoTop>
          <ButtonInfoBottom className={selectPromo ? 'new-promo' : 'new-promo clear'}>
            Udemy
          </ButtonInfoBottom>
        </ButtonInfo>
